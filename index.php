		        ...
		        <div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="head_title_rigth wow fadeInRight"  data-wow-duration="3s">
							<p>In the confectionary world <b>Bakaichi Bakery</b> continues to set the pace and innovation in this booming and constantly innovative industry. Sophisticated pastry lovers have learned to recognize and expect outstanding quality. As the pastry-lover's palette searches for an ever more sensuous pastry experience, <b>Bakaichi Bakery</b> will continue to satisfy the most discerning pastry connoisseurs. The Company's founders share a mutual passion for exceptional cakes and pastries.</p>
						</div>
					</div>
		...
		<section id="clientsaid_section" class="clientsaid">
			<div class="container">
				<div class="row">
					...
					<div id="carousel-said" class="carousel slide" data-ride="carousel">
						<!-- Indicators -->
						<ol class="carousel-indicators">
							<li data-target="#carousel-said" data-slide-to="0" class="active"></li>
							<li data-target="#carousel-said" data-slide-to="1"></li>
						</ol>
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active text-center">
								...
								<h5>Erwin Santoso Pusoko</h5>
								<h3>"bgsd Enak sumpah kuenya"</h3><br/><br/><br/><br/>
							</div>
							<div class="item text-center">
								...
								<span class="fa fa-star star-checked"></span>
								<span class="fa fa-star star-checked"></span>
								<h5>Iga Fitria Sukmawati</h5>
								<h3>"Pelayanannya tepat waktu"</h3><br/><br/><br/><br/>
							</div>
						</div>
